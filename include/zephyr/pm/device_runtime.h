 ...
 * 	auto-device-runtime property in pm.yaml and z_sys_init_run_level.
 *
...
#else
static inline int pm_device_runtime_auto_enable(const struct device *dev) { return 0; }
...
static inline bool pm_device_runtime_auto_is_enabled(const struct device *dev) { return false; }
